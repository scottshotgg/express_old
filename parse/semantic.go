...
// 	// 	metaTokens := meta.EndToked 'package', found 'EOF'ns[0].Value.True.([]token.Token)
// 	// 	metaTokens = append(append scottshotgg@antergos  ~/Development/go/src/github.com/scottshotgg/Express   rearch ● ?                                                                                                                                                                                   1 ↵  1590  21:35:05 ([]token.Token{token.TokenMap["{"]}, metaTokens...), token.TokenMap["}"])
